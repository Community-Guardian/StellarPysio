...
class PaymentAdmin(admin.ModelAdmin):
    list_display = ('id', 'service', 'payment_method', 'payment_status', 'amount', 'transaction_id', 'created_at', 'updated_at')
    search_fields = ('service__id', 'payment_method', 'payment_status', 'transaction_id')
