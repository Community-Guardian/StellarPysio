"""
Django settings for StellarPhysioBackend project.
...
SECRET_KEY = 'django-insecure-t1*n@ewsb$tl!j!9^uz=t!zdh%u8q*-x6cf8wr@d%*6g&s8jrn'
...
ROOT_URLCONF = 'StellarPhysioBackend.urls'
...
WSGI_APPLICATION = 'StellarPhysioBackend.wsgi.application'
